...
python -u "main.py" -datapath "dummy" -epoch 1 -bs 5 -num_input_images 1 -framelim 40 -criterion 'L2' -localexp "" -lr 1e-4 -expnum "e000" -hidden_dim 9 -inputt "img" -outputt "orient" -lb "orient" -no_loadh5 -minmax_fn "" -parallel "torch" -machine "lenovo" -merging "color" -aug_gt "orient" -updateFraction 0.25 -steplr 1000 1 -print_minibatch 1
