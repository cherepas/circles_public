...
kwargs = {'num_workers': 0, 'pin_memory': False} if opt.parallel == 'hvd' else {}
...
cip = []
# i = 0
for root, directories, filenames in os.walk(os.path.join(mainpath, csvname)):
...
excpath = os.path.join(mainpath,opt.specie+'_exceptions.csv')
if not os.path.isfile(excpath):   
