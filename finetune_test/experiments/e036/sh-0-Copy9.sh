...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -bn 5 -epoch 300 -bs 50 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-3 -ampl 441 -expnum e036 -num_input_images 3 -rand_angle -specie 598 -rescale 500 -hidden_dim 'hidden_dim = np.hstack((np.repeat(128, 0),441))' -num_sam_points 1000