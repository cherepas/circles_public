...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5000 -epoch 2 -bs 50 -minmax -minimax3dimage -normalize -center -classicnorm -expnum 017