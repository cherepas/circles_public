...
cd "${HOMEPATH}/cherepashkin1/circles/"
git add *
git commit -m "${EXPNUM}_draft"
git push origin main

python -u "${HOMEPATH}/cherepashkin1/circles/finetune_test/main.py" -epoch 3 -bs 5 -num_input_images 3 -framelim 40 -criterion 'L2' -localexp "draft" -lr 1e-4 -expnum "$EXPNUM" -hidden_dim 9 -inputt "img" -outputt "orient" -lb "orient" -aug_gt "orient" -minmax_fn "" -parallel "torch" -machine "lenovo" -merging "batch" -updateFraction 0.25 -steplr 1000 1 -print_minibatch 1
