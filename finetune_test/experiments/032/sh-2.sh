...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 50 -epoch 10 -bs 50 -expnum 032 -no_minmax -no_minmax3dimage -normalize -no_center -classicnorm