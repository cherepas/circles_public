...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5 -epoch 300 -bs 50 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-3 -ampl 441 -weight_decay 0  -expnum 033 -num_input_images 1 -hidden_dim 'hidden_dim = np.hstack((np.repeat(512, 3),441))'