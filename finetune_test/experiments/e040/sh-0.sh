...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'change size of appended FC layers' -bn 5 -epoch 300 -bs 40 -no_minmax -no_normalize -no_center -classicnorm -lr 1e-6 -ampl 441 -expnum e040 -num_input_images 3 -rand_angle -specie 598 -rescale 500 -hidden_dim 'hidden_dim = np.array([5000,2500,1000,441])' -loss_between 'f' 