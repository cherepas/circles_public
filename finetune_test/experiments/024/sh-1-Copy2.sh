...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5000 -epoch 10 -bs 50 -no-minmax -no-normalize -no-center -classicnorm -lr 5e-3 -expnum 024 -ampl 441 -model_name 'alexnet' -hidden_dim "hidden_dim = np.hstack((np.repeat(128, 3),441))"