...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'zero angle, L2 norm, more epochs, instant plots' -bn 150 -epoch 500 -bs 40 -lr 5e-7 -expnum e053 -cmscrop 550 -hidden_dim 'hidden_dim = np.array([441])' -loss_between 'f' -criterion 'L2' -inputt 'img' -haf -use_existing_csv -zero_angle