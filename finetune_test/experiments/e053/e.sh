...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'image corresponds to rotation angle, real angle is horizontal' -bn 150 -epoch 150 -bs 40 -no_classicnorm -no_normalize -lr 5e-7 -expnum e053 -cmscrop 550 -hidden_dim 'hidden_dim = np.array([441])' -loss_between 'f' -criterion 'L1' -inputt 'img' -haf -not_use_existing_csv -no_rand_angle