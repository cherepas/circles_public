...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'mix data with ara' -bn 5 -epoch 300 -bs 40 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-5 -ampl 441 -expnum e041 -num_input_images 3 -rand_angle -specie 619 -rescale 500 -hidden_dim 'hidden_dim = np.array([5000,2500,1000,441])' -loss_between 'f' 