...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 1000 -bn 1000 -bs 64 -lr 1e-4 -no_minmax -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 550 -rescale 250 -no_use_adasum -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(128, 1),1500))" -inputt "img" -num_input_images 3 -specie "598" -lb "f" -no_rand_angle -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv11" -pc_scale 100 -no_view_sep -no_rot_dirs -parallel "torch" -machine "workstation" -wandb "" -no_measure_time -merging_order 'color_channel' -updates_per_epoch 3 -no_rotate_output -steplr 30 0.1 -localexp "" -batch_output 1000
