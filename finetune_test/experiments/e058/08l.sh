...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 1000 -bn 1 -bs 5 -num_input_images 3 -framelim 2000 -rescale 250 -cencrop 550 -framelim 2000 -criterion 'L1' -localexp "777" -lr 1e-3 -expnum "$EXPNUM" -hidden_dim 32 1500 -inputt "img"  -lb "pc" -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv9" -parallel "torch" -machine "lenovo" -wandb "" -merging_order 'color_channel' -updateFraction 1 -steplr 10 0.1 -batch_output 2 -cmscrop 0