...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 1 -bn 2 -bs 3 -localexp "drafts" -lr 1e-3 -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(128, 1),1500))" -inputt "img" -num_input_images 2 -lb "f" -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv9" -parallel "torch" -machine "lenovo" -wandb "" -merging_order 'color_channel' -updates_per_epoch 3 -steplr 30 0.1 -batch_output 10
