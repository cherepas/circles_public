...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 1 -bn 2 -bs 5 -num_input_images 3 -rescale 250 -cencrop 800 -framelim 2000 -criterion 'L1' -localexp "" -lr 1e-5 -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(128, 1),500,1000,1500))" -inputt "img"  -lb "pc" -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv11" -parallel "torch" -machine "lenovo" -wandb "" -merging_order 'color_channel' -updateFraction 1 -steplr 30 0.1 -batch_output 10 -cmscrop 0
