...
python -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/main.py -expdescr "truly normalized dataset" -bn 1000 -epoch 300 -bs 64 -lr 1e-2 -expnum e054 -cmscrop 550 -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -lb "pc" -criterion "L1" -outputt "single_f_n" -num_input_images 1 -view_sep -csvname "598csv11" -no_rot_dirs -parallel "hvd" -pc_scale 100 -wandb ""
