...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/main.py -expdescr '3d reconstruction of resampled pc' -bn 150 -epoch 500 -bs 40 -no_classicnorm -no_normalize -lr 5e-8 -expnum e054 -cmscrop 550 -hidden_dim 'hidden_dim = np.hstack((np.repeat(32, 1),441))' -loss_between 'f' -criterion 'L2' -inputt 'img' -haf -use_existing_csv -no_rand_angle -num_input_images 1 -outputt 'f_n' -csvname '598csv' -no_view_sep