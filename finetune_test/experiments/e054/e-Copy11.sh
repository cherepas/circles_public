...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/main.py -expdescr 'try unnormalize dataset' -bn 150 -epoch 200 -bs 128 -no_classicnorm -no_normalize -lr 1e-3 -expnum e054 -cmscrop 550 -hidden_dim 'hidden_dim = np.hstack((np.repeat(32, 1),1500))' -lb 'pc' -criterion 'L1' -inputt 'img' -outputt 'single_f_n' -haf -use_existing_csv -no_rand_angle -num_input_images 36 -view_sep -csvname '598csv9' -no_rot_dirs 