...
python -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/main.py -expdescr "598csv11, 3 views with rotate output" -bn 5 -epoch 1 -bs 64 -lr 1e-3 -expnum e054 -cmscrop 550 -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -lb "pc" -criterion "L1" -inputt "img" -outputt "single_f_n" -num_input_images 3 -view_sep -csvname "598csv11" -no_rot_dirs -rotate_output -pc_scale 100 -machine "jureca" -wandb "" -parallel "hvd" -noise_input
