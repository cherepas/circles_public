...
python -u D:/circles/finetune_test/main_21.10.py -epoch 2 -bn 5 -bs 15 -lr 1e-3 -no_minmax -no_minmax3dimage -downsample 1 -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 550 -rescale 550 -no_use_adasum -expnum "e056" -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -chidden_dim "chidden_dim = np.hstack((96,128,np.repeat(256, 3)))" -kernel_sizes "kernel_sizes = np.hstack((7,np.repeat(3, 5)))" -inputt "img" -no_feature_extract -weight_decay 0 -num_input_images 1 -specie "598" -loss_between "pc" -no_rand_angle -no_zero_angle -outputt "single_f_n" -csvname "598csv9" -pc_scale 100 -no_view_sep -no_noise_input -parallel "torch" -no_save_output -machine "workstation" -no_noise_input -num_workers 0
