...
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 10 -bs 7 -num_input_images 1 -framelim 25 -rescale 500 -cencrop 700 -outputt "pose6" -criterion 'L2' -localexp "" -lr 1e-5 -expnum "$EXPNUM" -hidden_dim 6 -inputt "img" -lb "pose6" -zero_angle -gttype "single_f_n" -csvname "598csv9" -parallel "torch" -machine "lenovo" -wandb "" -merging_order 'color_channel' -updateFraction 0.2 -steplr 20 0.2 -batch_output 2 -cmscrop 0 -weight_decay 0 -print_minibatch 1
