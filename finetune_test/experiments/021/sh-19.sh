...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5000 -epoch 100 -bs 50 -minmax -no-normalize -no-center -classicnorm -lr 1e-3 -expnum "021" -hidden_dim "hidden_dim = np.hstack((np.repeat(145, 3),441))"