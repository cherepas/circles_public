...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh2.py -expdescr 'vary nsp ' -bn 5 -epoch 100 -bs 40 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-7 -ampl 441 -expnum e044 -num_input_images 1 -rand_angle -specie '598' -rescale 500 -hidden_dim 'hidden_dim = np.array([5000,2500,1000,441])' -loss_between 'f' -num_sam_points 2000