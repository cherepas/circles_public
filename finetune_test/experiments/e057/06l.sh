...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main - full on 5_11.py" -epoch 300 -bn 100 -bs 2 -lr 1e-3 -no_minmax -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 550 -rescale 250 -no_use_adasum -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -inputt "img" -num_input_images 36 -specie "598" -lb "pc" -no_rand_angle -zero_angle -outputt "single_f_n" -csvname "598csv9" -pc_scale 100 -no_view_sep -no_rot_dirs -parallel "torch" -machine "lenovo" -wandb "" -updates_per_epoch 4000
