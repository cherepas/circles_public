...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 1000 -bn 1000 -bs 70 -lr 1e-3 -no_minmax -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 550 -rescale 250 -no_use_adasum -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -inputt "img" -num_input_images 3 -specie "598" -lb "pc" -no_rand_angle -zero_angle -outputt "single_f_n" -csvname "598csv9" -pc_scale 100 -no_view_sep -no_rot_dirs -parallel "torch" -machine "lenovo" -wandb "" -no_measure_time -updates_per_epoch 4000 -localexp '' -steplr 30 0.1 -merging_order 'color_channel' -no_rotate_output -updates_per_epoch 5000
