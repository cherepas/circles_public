...
python -u D:/circles/finetune_test/main.py -epoch 300 -bn 1000 -bs 4 -lr 1e-3 -no_minmax -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 0 -rescale 0 -no_use_adasum -expnum "e057" -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -inputt "img" -num_input_images 2 -specie "598" -lb "pc" -no_rand_angle -zero_angle -outputt "single_f_n" -csvname "598csv9" -pc_scale 100 -no_view_sep -no_rot_dirs -parallel "torch" -machine "huawei" -wandb "e057"
