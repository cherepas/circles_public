...
#echo "$EXPNUM"
python -u "${HOMEPATH}/circles/finetune_test/main_e054_041_or.py" -epoch 1000 -bn 1000 -bs 35 -lr 1e-3 -no_minmax -no_normalize -no_center -no_classicnorm -ampl 441 -cmscrop 550 -rescale 550 -no_use_adasum -expnum "$EXPNUM" -hidden_dim "hidden_dim = np.hstack((np.repeat(32, 1),1500))" -inputt "img" -num_input_images 1 -specie "598" -lb "pc" -no_rand_angle -zero_angle -outputt "single_f_n" -csvname "598csv9" -pc_scale 100 -no_view_sep -no_rot_dirs -parallel "torch" -machine "workstation" -wandb "" -no_measure_time
