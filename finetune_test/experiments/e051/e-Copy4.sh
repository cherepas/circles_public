...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'cmscrop, take image rotation number 0, classic norm, L1 norm' -bn 5 -epoch 500 -bs 40 -classicnorm -minmax3d -normalize -lr 5e-7 -expnum e051 -cmscrop 550 -hidden_dim 'hidden_dim = np.array([5000,2500,1000,441])' -loss_between 'f' -criterion 'L1' -inputt 'pc' -downsample 10 -no_haf