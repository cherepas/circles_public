...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh2.py -expdescr 'cmscrop, fix image rotation angle, classic norm, L1 norm' -bn 5 -epoch 300 -bs 40 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-7 -ampl 441 -expnum e051 -num_input_images 1 -no_rand_angle -specie '598' -cmscrop 550 -rescale 550 -hidden_dim 'hidden_dim = np.array([5000,2500,1000,441])' -loss_between 'f' -num_sam_points 500 -use_existing_csv -criterion 'L1' -inputt 'img'