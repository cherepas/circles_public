...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'cmscrop, fix image rotation angle, classic norm, L1 norm' -bn 5 -epoch 500 -bs 40 -classicnorm -lr 5e-7 -expnum e051 -cmscrop 550 -hidden_dim 'hidden_dim = np.array([5000,4500,4000,3500,3000,2500,2000,1500,1000,441])' -loss_between 'f' -criterion 'L1' -inputt 'img'