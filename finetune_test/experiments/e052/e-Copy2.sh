...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh2.py -expdescr 'check compute time' -bn 5 -epoch 2 -bs 40 -lr 5e-7 -expnum e052 -ngpu 3 -parallel 'hvd' -model_name 'densenet' -inputt 'img' -num_input_images 3 -rescale 250