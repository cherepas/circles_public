...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'fibonacci sampled F 500 as input' -bn 5 -epoch 1000 -bs 40 -minmax -minmax_f -lr 1e-3 -expnum e050 -hidden_dim 'hidden_dim = np.array([441])' -loss_between 'f_n' -num_sam_points 500 -use_existing_csv -inputt 'f' -no_haf