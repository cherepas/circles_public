...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh.py -expdescr 'fibonacci sampled F 500 as input' -bn 5 -epoch 10000 -bs 40 -minmax -minmax_f -lr 5e-7 -expnum e050 -hidden_dim 'hidden_dim = np.array([441*500,441])' -loss_between 'f' -num_sam_points 500 -use_existing_csv -inputt 'f' -no_haf