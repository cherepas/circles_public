...
#python -u "${HOMEPATH}/cherepashkin1/598test/plot_output/e065/${CONTRAIN}/main.py"

python -u "${HOMEPATH}/circles/finetune_test/main.py" -epoch 2 -bs 15 -num_input_images 3 -framelim 50 -rescale 500 -cencrop 700 -criterion 'L1' -localexp "" -conTrain "$CONTRAIN" -lr 1e-3 -expnum "$EXPNUM" -hidden_dim 16 1500 -inputt "img" -lb "pc" -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv9" -parallel "torch" -machine "lenovo" -wandb "" -merging_order 'color_channel' -updateFraction 1 -steplr 1000 1 -batch_output 2 -cmscrop 0 -weight_decay 0
