...
python -u "${HOMEPATH}/circles/finetune_test/main_e058_000w.py" -epoch 1000 -bs 15 -bn 1000 -num_input_images 3 -framelim 2000 -rescale 500 -cencrop 700 -criterion 'L1' -localexp "" -lr 1e-3 -expnum "$EXPNUM" -hidden_dim 'hidden_dim=np.array([16, 1500])' -inputt "img" -lb "pc" -zero_angle -gttype "single_f_n" -outputt "pc" -csvname "598csv9" -parallel "torch" -machine "workstation" -wandb "" -merging_order 'color_channel' -updateFraction 1 -steplr 1000 1 -batch_output 2 -cmscrop 0 -weight_decay 0
