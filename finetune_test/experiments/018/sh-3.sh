...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5000 -epoch 100 -bs 50 -minmax -no-normalize -no-center -classicnorm  -expnum 018 -lr 0.0001