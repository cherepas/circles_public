...
srun --cpu-bind=none,v python3 -u /p/home/jusers/cherepashkin1/jureca/circles/finetune_test/sh-clean-hvd.py -bn 5000 -epoch 100 -bs 50 -no_minmax -no_normalize -no_center -classicnorm -lr 5e-3 -ampl 441 -weight_decay 0 -num_input_images 1 -expnum 028 -chidden_dim "chidden_dim = np.hstack((96,128,np.repeat(48, 2)))"