...
python -u "../../main.py" -datapath "D:/cherepashkin1/phenoseed/" -realjobname `basename "$0"` -jobname "e074w018.sh" -jobdir "$SCRIPT_DIR" -expnum "e074" -epoch 100 -bs 5 -num_input_images 3 -framelim 500 -criterion "L2" -rmdirname -lr 5e-5 -hidden_dim 32 9 -inputt "img" -outputt "orient" -lb "orient" -no_loadh5 -minmax_fn "" -parallel "torch" -machine "workstation" -merging "batch" -aug_gt ""  -updateFraction 0.25 -steplr 1000 1 -print_minibatch 10 -dfname "598frame"

python -u "../../main.py" -datapath "D:/cherepashkin1/phenoseed/" -realjobname `basename "$0"` -jobname "e074w019.sh" -jobdir "$SCRIPT_DIR" -expnum "e074" -epoch 100 -bs 5 -num_input_images 3 -framelim 500 -criterion "L2" -rmdirname -lr 1e-5 -hidden_dim 32 9 -inputt "img" -outputt "orient" -lb "orient" -no_loadh5 -minmax_fn "" -parallel "torch" -machine "workstation" -merging "batch" -aug_gt ""  -updateFraction 0.25 -steplr 1000 1 -print_minibatch 10 -dfname "598frame"

python -u "../../main.py" -datapath "D:/cherepashkin1/phenoseed/" -realjobname `basename "$0"` -jobname "e074w020.sh" -jobdir "$SCRIPT_DIR" -expnum "e074" -epoch 100 -bs 5 -num_input_images 3 -framelim 500 -criterion "L2" -rmdirname -lr 5e-6 -hidden_dim 32 9 -inputt "img" -outputt "orient" -lb "orient" -no_loadh5 -minmax_fn "" -parallel "torch" -machine "workstation" -merging "batch" -aug_gt ""  -updateFraction 0.25 -steplr 1000 1 -print_minibatch 10 -dfname "598frame"

python -u "../../main.py" -datapath "D:/cherepashkin1/phenoseed/" -realjobname `basename "$0"` -jobname "e074w021.sh" -jobdir "$SCRIPT_DIR" -expnum "e074" -epoch 100 -bs 5 -num_input_images 3 -framelim 500 -criterion "L2" -rmdirname -lr 1e-6 -hidden_dim 32 9 -inputt "img" -outputt "orient" -lb "orient" -no_loadh5 -minmax_fn "" -parallel "torch" -machine "workstation" -merging "batch" -aug_gt ""  -updateFraction 0.25 -steplr 1000 1 -print_minibatch 10 -dfname "598frame"
